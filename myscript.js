  ...
  const kformNote = document.getElementById('kformNote');
  kontaktForm.addEventListener('submit', (e) => {
    e.preventDefault();
    kformNote.textContent = 'Hvala! Ovo je samo demo — poveži formu s pravim backendom da poruke stvarno stižu.';
    kontaktForm.reset();
  });
...
form.addEventListener('submit', async (e) => {
  ...
  try {
    const response = await fetch('https://formspree.io/f/xrenrpor', {
      method: 'POST',
      body: data,
      headers: {
